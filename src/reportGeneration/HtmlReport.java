...
public class HtmlReport {
	...
	public static void getscenarioTemp() throws IOException {
		...
		bw.newLine();
		bw.write("<h2>PMS Test Report</h2>");
	}
	...
	public static void getSummary() throws IOException, ParseException {
		...
		// a=this.legend;a&&a.invalidateSize()},addEventListeners:function(a,b){var
	...
	public static void getPage() throws IOException, InterruptedException {
		...
		File htmlFile = new File("D:\\seleniumReport\\" + ExcelUtil.ScreenName + "_" + date + ".html");
		...
		HtmlConverter.convertToPdf(new FileInputStream(htmlFile),
				...
				new FileOutputStream("D:\\seleniumReport\\" + ExcelUtil.ScreenName + "_" + Keywords.date + ".PDF"));
