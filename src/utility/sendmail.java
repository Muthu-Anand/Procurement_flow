...
public class sendmail {
	...
	public void mail() throws IOException {
		...
		Session session = Session.getDefaultInstance(props,
				...
				new javax.mail.Authenticator() {
					...
					protected PasswordAuthentication getPasswordAuthentication() {
						...
						return new PasswordAuthentication("pushpaofficemail@gmail.com", "nlevrptoxwwaqrbu");
		...
		try {
			...
			message.setFrom(new InternetAddress("pushpaofficemail@gmail.com", "NoReply"));
			...
			message.setSubject("ProcurementReport_" + ExcelUtil.ScreenName + "_" + ExcelUtil.Testcycle);
			...
			IOUtils.copy(
					new FileInputStream(
							new File("D:\\seleniumReport1\\" + ExcelUtil.ScreenName + "_" + HtmlReport.date + ".html")),
					writer, "ISO-8859-1");
			...
			String Pdffile = "D:\\seleniumReport\\" + ExcelUtil.ScreenName + "_" + Keywords.date + ".PDF";
